...
// NUM_ORACLES=4
// CONFIG_DIGEST=0x00019993762936b47169aed484186706ccff0ae15fe43f31741d66ad16b4a8ac
...
async function main() {
  ...
  const NUM_ORACLES = parseInt(process.env.NUM_ORACLES || "4", 10);
  const REAL_DIGEST = process.env.CONFIG_DIGEST || "0x00019993762936b47169aed484186706ccff0ae15fe43f31741d66ad16b4a8ac";
  ...
  const fValue = parseInt(process.env.FAULT_TOLERANCE || "1", 10);
